...
import com.hzy.views.rolling.StaticLayoutHelper;
...
public class MultiLineStrategy implements IStrategy {
    ...
    private void setupAutoSizeText(float autoSizeMinTextSizeInPx,
        ...
        // not have icon_card_bg_shape predefined set of sizes or if the current sizes array is empty.
        if (mAutoSizeTextSizesInPx.length == 0) {
            ...
            // Also reserve icon_card_bg_shape slot for the max size if it fits.
