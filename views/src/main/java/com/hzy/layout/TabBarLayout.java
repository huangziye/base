...
public class TabBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public void onPageSelected(int position) {
        ...
        if (onItemSelectedListener != null) {
            onItemSelectedListener.onItemSelected(getTabbarItem(position), mCurrentItem, position);
        }
        ...
        public void onClick(View v) {
            ...
            if (mViewPager != null) {
                ...
                if (currentIndex == mCurrentItem) {
                    ...
                    if (onItemSelectedListener != null) {
                        onItemSelectedListener.onItemSelected(getTabbarItem(currentIndex), mCurrentItem, currentIndex);
                    }
                } else {
