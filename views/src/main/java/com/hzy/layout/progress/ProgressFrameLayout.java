...
public class ProgressFrameLayout extends FrameLayout implements ProgressLayout {
    ...
    public ProgressFrameLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ProgressFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
