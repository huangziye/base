...
public class ProgressRelativeLayout extends RelativeLayout implements ProgressLayout {
    ...
    public ProgressRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ProgressRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
